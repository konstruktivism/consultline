...
return [
     ...
     */
    'fonts' => [
        'sans' => 'https://fonts.googleapis.com/css2?family=Albert+Sans:wght@400;500;600;700;800;900&display=swap',
        'mono' => 'https://fonts.googleapis.com/css2?family=Space+Mono:ital,wght@0,400;0,700;1,400;1,700&display=swap',
    ],
    ...
    /*
     * Prepend all files that are written to the selected disk with this path.4
